...
(function($) {
			...
			var newList = {
				...
				dropItem: function() {
                    ...
                    $("#gridtbody").children().each(function () {
                        ...
                        $(this).find("td:first-child").html("<input id='sort' name='sort' type='text' class='form-control' value="+tmpp + 1 +">");
                    })

                    var len = $('#field_list_table tr').length;
                    for (var i = 1; i < len; i++) {

                        $('#field_list_table tr:eq(' + i + ') td:first').html("<input id='sort' name='sort' type='text' class='form-control' value="+i+">");
                    }
					// 结束
					return false;
				},
	...
	$.fn.dragsort.defaults = {
		itemSelector: "",
		dragSelector: "",
		dragSelectorExclude: "input, textarea, select, a",
		dragEnd: function() { },
		dragBetween: false,
		placeHolderTemplate: "",
